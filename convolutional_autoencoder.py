...
class ConvAutoencoder:
    ...
    def __init__(self, 
        ...
        #num de filtros que tiene cada capa
    ...
    def build(self, use_batch_norm=False, use_dropout=False, VCAE=False):
        ...
        x = encoder_input
        #Creando las capas convolucionales
        ...
        #Almacenar las shapes de las capa de mi red antes menos la primera
        #para luego poder reconstruir la misma dimensión
        ...
        #Estas dos líneas no las entendí
        ...
        for i in range(len(self.decoder_conv_filters)):
            ...
            #En la última capa del decoder si se aplica leakyrelu en las demás
            #anteriores sigmoid
            #En estas capas no se aplican dropout ni batchnormalization
    ...
    def train(self, data_flow, epochs, steps_per_epoch, data_flow_val, run_folders):
        ...
        #los pesos del modelo se guardan 
        ...
        #Actualizar la learning rate en una época
        ...
        #Guardar el modelo, la arquitectura
